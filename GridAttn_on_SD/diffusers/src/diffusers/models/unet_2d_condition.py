...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        elif mid_block_type == "UNetMidBlock2DCrossGridAttn":
            self.mid_block = UNetMidBlock2DCrossAttn(
                in_channels=block_out_channels[-1],
                temb_channels=blocks_time_embed_dim,
                resnet_eps=norm_eps,
        ...
        # self.cost = {"cnt": 0, "preprocess":0, "embedding":0, "pre-conv":0,
        #              "down_block":0, "down_block_additional_residuals":0, "mid_block":0,
        #              "up_block":0, "postprocess":0, "overall":0}
